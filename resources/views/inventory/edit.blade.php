...
<head>
    ...
    <title>Edit Product - SariSari Store System</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="form-card">
            <form method="POST" action="{{ route('inventory.index', $product->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="number" id="stock_max" name="stock_max" value="{{ old('stock_max', $product->stock_max) }}" min="1" required>
                    ...
                    <div class="form-group">
                        ...
                        <select id="status" name="status" required>
                            ...
                            <option value="low" {{ old('status', $product->status) == 'low' ? 'selected' : '' }}>Low Stock</option>
                            <option value="out" {{ old('status', $product->status) == 'out' ? 'selected' : '' }}>Out of Stock</option>
                        </select>
