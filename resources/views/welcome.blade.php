  ...
  <div class="auth-cards">
    <div class="auth-card auth-card-login">
      <div class="auth-card-icon">
        <svg width="26" height="26" viewBox="0 0 26 26" fill="none"><circle cx="13" cy="8.5" r="4.5" stroke="currentColor" stroke-width="1.8"/><path d="M3 23c0-5.5 4.5-10 10-10s10 4.5 10 10" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/></svg>
      </div>
    ...
    <div class="auth-card auth-card-register">
      <div class="auth-card-icon register-icon">
        <svg width="26" height="26" viewBox="0 0 26 26" fill="none"><circle cx="11" cy="8.5" r="4.5" stroke="currentColor" stroke-width="1.8"/><path d="M2 23c0-5.5 4-10 9-10" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/><path d="M20 16v6M17 19h6" stroke="currentColor" stroke-width="2" stroke-linecap="round"/></svg>
      </div>
...
<footer class="footer">
  <div class="footer-logo">
    <span class="footer-icon">
      <svg width="20" height="20" viewBox="0 0 28 28" fill="none"><path d="M4 11 L14 3 L24 11" stroke="currentColor" stroke-width="2" stroke-linejoin="round" fill="none"/><rect x="6" y="11" width="16" height="13" rx="1.5" fill="none" stroke="currentColor" stroke-width="1.5"/><rect x="11" y="17" width="6" height="7" rx="1" fill="currentColor"/></svg>
    </span>
    SariSari Store System
  </div>
  <p class="footer-copy">&copy; <span id="yr"></span> · Made with ❤️ for Asian sari-sari stores</p>
</footer>
